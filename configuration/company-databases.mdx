...
description: "Configure the nine branch company databases and the Hechizo hub company in config.ini. Understand database naming conventions and business partner code mapping."
---
