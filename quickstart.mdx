---
title: "Configure and Run Hechizo SAP Intercompany (MCH_IC.exe)"
sidebarTitle: "Quickstart"
description: "Build the project for x64, drop config.ini next to the executable, and schedule MCH_IC.exe to sync all ten SAP Business One companies automatically."
---
