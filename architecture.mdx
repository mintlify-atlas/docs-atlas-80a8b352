---
title: "Hechizo Intercompany Architecture and Data Flow"
...
<Steps>
  <Step title="Error Registry Initialization">
    ...
    ```
    Initializes or resets the `@SINCROERROR` custom table in SAP. This runs before any sync work so that the error table is clean and ready to receive failures from the current cycle.
  </Step>
